...
export const Pieces = {
    FlowerOfLife: new Genshin.Piece("Flower of Life", "生之花", new Lottery([MainStat.FlatHP]), subStat1, subCount),
    PlumeOfDeath: new Genshin.Piece("Plume of Death", "死之羽", new Lottery([MainStat.FlatATK]), subStat1, subCount),
    SandsOfEon: new Genshin.Piece("Sands of Eon", "时之沙", new Lottery([
        MainStat.HP,
        MainStat.ATK,
        MainStat.DEF,
    ...
    GobletOfEonothem: new Genshin.Piece("Goblet of Eonothem", "空之杯", new Lottery([
        MainStat.HP,
        MainStat.ATK,
        MainStat.DEF,
    ...
    CircletOfLogos: new Genshin.Piece("Circlet of Logos", "理之冠", new Lottery([
        MainStat.HP,
        MainStat.ATK,
        MainStat.DEF,
        MainStat.CRITRate,
