...
const pieces = new Lottery<Genshin.Piece>(lodash.values(Pieces));
const piecesAlt = new Lottery<Genshin.Piece>(lodash.values(PiecesAlt));

export const Sets = {
    EmblemOfSeveredFate: new Genshin.Set(
    ...
    ShimenawasReminiscence: new Genshin.Set(
    ...
    DeepwoodMemories: new Genshin.Set(
    ...
    MarechausseeHunter: new Genshin.Set(
...
Object.keys(Sets).forEach(x => {
    let y: Genshin.Set = Object.create(Sets[x]);
